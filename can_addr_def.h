...
#define CA_IMU_SampleTime_IDX 0
#define CA_IMU_GroupCnt_IDX 0
#define CA_IMU_Status_IDX 0
#define CA_IMU_Quat_0_LOW_IDX 0
#define CA_IMU_Quat_0_HIGH_IDX 1
#define CA_IMU_Quat_1_LOW_IDX 2
#define CA_IMU_Quat_1_HIGH_IDX 3
#define CA_IMU_Quat_2_LOW_IDX 4
#define CA_IMU_Quat_2_HIGH_IDX 5
#define CA_IMU_Quat_3_LOW_IDX 6
#define CA_IMU_Quat_3_HIGH_IDX 7
#define CA_IMU_dv_x_LOW_IDX 0
#define CA_IMU_dv_x_HIGH_IDX 1
#define CA_IMU_dv_y_LOW_IDX 2
#define CA_IMU_dv_y_HIGH_IDX 3
#define CA_IMU_dv_z_LOW_IDX 4
#define CA_IMU_dv_z_HIGH_IDX 5
#define CA_IMU_dv_exp_LOW_IDX 6
#define CA_IMU_dv_exp_HIGH_IDX 7
#define CA_IMU_RateTurn_x_LOW_IDX 0
#define CA_IMU_RateTurn_x_HIGH_IDX 1
#define CA_IMU_RateTurn_y_LOW_IDX 2
#define CA_IMU_RateTurn_y_HIGH_IDX 3
#define CA_IMU_RateTurn_z_LOW_IDX 4
#define CA_IMU_RateTurn_z_HIGH_IDX 5
#define CA_IMU_dq_0_LOW_IDX 0
#define CA_IMU_dq_0_HIGH_IDX 1
#define CA_IMU_dq_1_LOW_IDX 2
#define CA_IMU_dq_1_HIGH_IDX 3
#define CA_IMU_dq_2_LOW_IDX 4
#define CA_IMU_dq_2_HIGH_IDX 5
#define CA_IMU_dq_3_LOW_IDX 6
#define CA_IMU_dq_3_HIGH_IDX 7
#define CA_IMU_ACC_x_LOW_IDX 0
#define CA_IMU_ACC_x_HIGH_IDX 1
#define CA_IMU_ACC_y_LOW_IDX 2
#define CA_IMU_ACC_y_HIGH_IDX 3
#define CA_IMU_ACC_z_LOW_IDX 4
#define CA_IMU_ACC_z_HIGH_IDX 5
#define CA_IMU_FreeACC_x_LOW_IDX 0
#define CA_IMU_FreeACC_x_HIGH_IDX 1
#define CA_IMU_FreeACC_y_LOW_IDX 2
